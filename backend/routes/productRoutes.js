...
router.get('/organization-campaign/:campaignId', auth, isOrganization, productController.getOrganizationCampaignProducts);
...
router.put('/:id', auth, upload.single('anh'), productController.updateProduct);
